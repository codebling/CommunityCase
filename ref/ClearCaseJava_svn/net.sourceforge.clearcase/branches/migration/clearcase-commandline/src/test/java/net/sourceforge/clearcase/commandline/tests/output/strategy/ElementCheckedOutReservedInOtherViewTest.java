...
public class ElementCheckedOutReservedInOtherViewTest {

	@Test
	public void testCheck() {
		AbstractMatcherStrategy strategy = new ElementCheckedOutReservedInOtherView();
		String element = "c:\\test";
		StringBuffer output = new StringBuffer("cleartool: Error: Branch \""
				+ element + "\" of element is checked out reserved by view .*");
