...
public class ICCVersion extends DispatchPtr {
    static public final GUID proxyIID = new GUID("{B22C7ED6-5A5E-11D3-B1CD-00C04F8ECE2F}");


    static public final int iidToken;

    static {
        iidToken = IdentityManager.registerProxy(proxyIID, ICCVersion.class);
    }
    ...
    public ICCVersion() throws COMException {
        super();
    }
    public ICCVersion(String progid) throws COMException {
        super(progid);
    }
    public ICCVersion(IUnknown other) throws COMException {
        super(other);
    }
    public ICCVersion(GUID ClsID) throws COMException {
        super(ClsID);
    }
