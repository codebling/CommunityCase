...
public class MostRecentNotPredecessorTest {
	...
	public void testCheck() {
		AbstractMatcherStrategy strategy = new MostRecentNotPredecessor();
		String element = "c:\\test";
		StringBuffer output = new StringBuffer(
				"cleartool: Error: The most recent version on branch \"test\"")
				.append("\n").append(
		...
		assertEquals(err.getType(),
				Error.MOST_RECENT_NOT_PREDECESSOR_OF_THIS_VERSION);
	}
