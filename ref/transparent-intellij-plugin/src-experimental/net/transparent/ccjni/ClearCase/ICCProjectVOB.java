...
public class ICCProjectVOB extends DispatchPtr {
    static public final GUID proxyIID = new GUID("{B22C7F27-5A5E-11D3-B1CD-00C04F8ECE2F}");


    static public final int iidToken;

    static {
        iidToken = IdentityManager.registerProxy(proxyIID, ICCProjectVOB.class);
    }
    ...
    public ICCProjectVOB() throws COMException {
        super();
    }
    public ICCProjectVOB(String progid) throws COMException {
        super(progid);
    }
    public ICCProjectVOB(IUnknown other) throws COMException {
        super(other);
    }
    public ICCProjectVOB(GUID ClsID) throws COMException {
        super(ClsID);
    }
    ...
    public ICCComponents getComponents() throws COMException {
        return new ICCComponents((DispatchPtr) get("Components"));
    }
    public java.lang.String getDefaultPromotionLevel() throws COMException {
        return (java.lang.String) get("DefaultPromotionLevel");
    }
    ...
    public int getNumberOfPromotionLevels() throws COMException {
        return ((java.lang.Integer) get("NumberOfPromotionLevels")).intValue();
    }
    ...
    public ICCProjects getProjects() throws COMException {
        return new ICCProjects((DispatchPtr) get("Projects"));
    }
    public java.lang.Object getPromotionLevelsStringArray() throws COMException {
        return (java.lang.Object) get("PromotionLevelsStringArray");
    }
    public ICCFolder getRootFolder() throws COMException {
        return new ICCFolder((DispatchPtr) get("RootFolder"));
    }
