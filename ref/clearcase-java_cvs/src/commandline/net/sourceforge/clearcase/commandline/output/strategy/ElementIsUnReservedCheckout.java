...
/**
 * TODO Provide description for ElementReservedCheckout.
 */
public class ElementIsUnReservedCheckout extends AbstractMatcherStrategy {
	...
	protected String getPattern() {
		return "Changed\\scheckout\\sto\\s(unreserved)\\sfor\\s\\\"(.*)\\\"\\sbranch\\s\\\"(.*)\\\"";
	...
	protected ClearCaseElementState getResult(String output, Matcher matcher)
		...
		return new ClearCaseElementState(matcher.group(2), ClearCase.UNRESERVED
