...
/**
 * When an rmname is done on the element. TODO Provide description for
 * ElementHasCheckOuts.
 */
public class ElementHasCheckOuts extends AbstractMatcherStrategy {
	...
	protected String getPattern() {
		return "cleartool: Error: Element \"(.*)\" has checkouts\\.";
	}
	...
	protected ClearCaseElementState getResult(String output, Matcher matcher)
		...
		throw new ClearCaseException(ClearCase.ERROR_ELEMENT_HAS_CHECKOUTS);
	}
}
