...
/**
 * This dialog shows a new root set
 */
class FixRootsDialog extends DialogWrapper {
  /**
   * The list of roots
   */
  private JList myRoots;
  /**
   * The root panel
   */
   ...
   */
  protected FixRootsDialog(Project project, HashSet<String> current, HashSet<String> added, HashSet<String> removed) {
    super(project, true);
    setTitle(Bundle.getString("fix.roots.title"));
    setOKButtonText(Bundle.getString("fix.roots.button"));
