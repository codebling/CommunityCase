...
public class CloneDialog extends DialogWrapper {
  ...
  public CloneDialog(Project project) {
    super(project, true);
    myProject = project;
    init();
    initListeners();
    setTitle(Bundle.getString("clone.title"));
    setOKButtonText(Bundle.getString("clone.button"));
  }
  ...
  private void initListeners() {
    ...
    myTestButton.addActionListener(new ActionListener() {
      public void actionPerformed(final ActionEvent e) {
        ...
        String output = HandlerUtil
          .doSynchronously(checkRepository(myProject, myTestURL), Bundle.message("clone.testing", myTestURL), "connection test");
        if (output != null) {
