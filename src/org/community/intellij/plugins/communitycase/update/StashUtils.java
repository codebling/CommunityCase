...
import org.community.intellij.plugins.communitycase.vfs.VfsListener;
...
public class StashUtils {
  ...
  public static ShelvedChangeList shelveChanges(final Project project, final ShelveChangesManager shelveManager, Collection<Change> changes,
    ...
    try {
      ...
      project.getMessageBus().syncPublisher(ShelveChangesManager.SHELF_TOPIC).stateChanged(new ChangeEvent(StashUtils.class));
      return shelve;
    }
    catch (IOException e) {
