 ...
 */
public class SkippedCommits extends PanelWithActionsAndCloseButton {
  /**
   * The current project
   */
   ...
   */
  public SkippedCommits(@NotNull ContentManager contentManager,
                        Project project, SortedMap<VirtualFile, List<RebaseUtils.CommitInfo>> skippedCommits) {
   ...
   */
  public static void showSkipped(final Project project, final SortedMap<VirtualFile, List<RebaseUtils.CommitInfo>> skippedCommits) {
  ...
  private static class Commit {
    final VirtualFile root;
    final RebaseUtils.CommitInfo commitInfo;

    public Commit(VirtualFile root, RebaseUtils.CommitInfo commitInfo) {
      this.root = root;
