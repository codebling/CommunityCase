...
public class Command {
  ...
  public static final Command ADD = write("add");
  public static final Command ANNOTATE = read("annotate");
  public static final Command BRANCH = meta("branch");
  public static final Command CHECKOUT = write("checkout");
  public static final Command COMMIT = write("commit");
  public static final Command CONFIG = meta("config");
  public static final Command CHECK_ATTR = read("check-attr");
  public static final Command CHERRY_PICK = write("cherry-pick");
  public static final Command CLONE = write("clone");
  public static final Command DESCRIBE = meta("describe");
  public static final Command DIFF = read("diff");
  public static final Command DIFF_INDEX = read("diff-index");
  public static final Command FETCH = write("fetch");
  public static final Command INIT = write("init");
  public static final Command LOG = meta("log");
  public static final Command LS_FILES = read("ls-files");
  public static final Command LS_REMOTE = meta("ls-remote");
  public static final Command MERGE = write("merge");
  public static final Command MERGE_BASE = meta("merge-base");
  public static final Command PULL = write("pull");
  public static final Command PUSH = write("push");
  public static final Command REBASE = writeSuspendable("rebase");
  public static final Command REMOTE = meta("remote");
  public static final Command RESET = write("reset");
  public static final Command REV_LIST = meta("rev-list");
  public static final Command RM = write("rm");
  public static final Command SHOW = write("show");
  public static final Command STASH = write("stash");
  public static final Command TAG = meta("tag");
  public static final Command UPDATE_INDEX = write("update-index");
  public static final Command VERSION = meta("version");
