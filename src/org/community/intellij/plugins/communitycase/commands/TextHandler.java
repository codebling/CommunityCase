...
public abstract class TextHandler extends Handler {
   ...
   */
  protected TextHandler(@NotNull Project project, @NotNull File directory, @NotNull Command command) {
   ...
   */
  protected TextHandler(final Project project, final VirtualFile vcsRoot, final Command command) {
  ...
  protected void startHandlingStreams() {
    ...
    myHandler.addProcessListener(new ProcessListener() {
      ...
      public void processTerminated(final ProcessEvent event) {
        ...
        cleanupEnv();
        TextHandler.this.processTerminated(exitCode);
      ...
      public void onTextAvailable(final ProcessEvent event, final Key outputType) {
        TextHandler.this.onTextAvailable(event.getText(), outputType);
      }
    });
