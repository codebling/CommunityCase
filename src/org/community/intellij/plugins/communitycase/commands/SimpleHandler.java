 ...
 * simple commands.
 */
public class SimpleHandler extends TextHandler {
  /**
   * Stderr output
   */
  ...
  public SimpleHandler(@NotNull Project project, @NotNull File directory, @NotNull Command command) {
   ...
   */
  @SuppressWarnings({"WeakerAccess"})
  public SimpleHandler(@NotNull final Project project, @NotNull final VirtualFile directory, @NotNull final Command command) {
    super(project, directory, command);
  }
