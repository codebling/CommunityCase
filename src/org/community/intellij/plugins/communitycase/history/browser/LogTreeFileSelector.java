...
public class LogTreeFileSelector extends DialogWrapper {
  ...
  public LogTreeFileSelector(final Project project, final VirtualFile root) {
    super(project, true);
  ...
  protected String getDimensionServiceKey() {
    return "org.community.intellij.plugins.communitycase.history.browser.LogTreeFileSelector";
  }
  ...
  private void initUi() {
    ...
    tree.setCellRenderer(new LogTreeFileSelectorRenderer(myProject));
