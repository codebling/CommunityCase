...
* @author irengrig
*/
public class CommitToCommitConvertor implements Convertor<Commit, CommitHashPlusParents> {
  private final static CommitToCommitConvertor ourInstance = new CommitToCommitConvertor();

  public static CommitToCommitConvertor getInstance() {
    return ourInstance;
  }

  @Override
  public CommitHashPlusParents convert(Commit o) {
