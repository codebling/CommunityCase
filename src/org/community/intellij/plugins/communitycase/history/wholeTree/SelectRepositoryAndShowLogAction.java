...
public class SelectRepositoryAndShowLogAction extends AnAction {
  ...
  private static class MyDialog extends DialogWrapper {
    ...
    private MyDialog(Project project, final VirtualFile[] virtualFiles) {
      super(project, true);
      myLog = LogFactoryService.getInstance(project).createComponent();
      myLog.rootsChanged(Arrays.asList(virtualFiles));
      init();
    }

    @Override
    protected JComponent createCenterPanel() {
      return myLog.getVisualComponent();
    }
    ...
    public JComponent getPreferredFocusedComponent() {
     // myLogLongPanel.setModalityState(ModalityState.current());
