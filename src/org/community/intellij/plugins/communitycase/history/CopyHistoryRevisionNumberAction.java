 ...
 */
public class CopyHistoryRevisionNumberAction extends AnAction implements DumbAware {

  /**
   * The constructor
   */
  public CopyHistoryRevisionNumberAction() {
    super(Bundle.getString("history.copy.revsion.number"),
          Bundle.getString("history.copy.revsion.number"),
