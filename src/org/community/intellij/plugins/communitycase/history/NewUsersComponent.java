 ...
 * @author irengrig
 */
public class NewUsersComponent {
  private final Object myLock = new Object();
  private SmallMapSerializer<String, List<String>> myState;
  private final File myFile;

  public NewUsersComponent(final Project project) {
    final File vcsFile = new File(PathManager.getSystemPath(), "vcs");
    File file = new File(vcsFile, "_users_new");
    file.mkdirs();
    myFile = new File(file, project.getLocationHash());
  }

  public static NewUsersComponent getInstance(final Project project) {
    return PeriodicalTasksCloser.getInstance().safeGetService(project, NewUsersComponent.class);
  }
