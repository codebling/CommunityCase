...
import org.community.intellij.plugins.communitycase.ui.ResetDialog;
 ...
 * The reset action
 */
public class ResetHead extends RepositoryAction {
  /**
   * {@inheritDoc}
   */
  @NotNull
  protected String getActionName() {
    return Bundle.getString("reset.action.name");
  }
  ...
  protected void perform(@NotNull Project project,
    ...
    ResetDialog d = new ResetDialog(project, Roots, defaultRoot);
    d.show();
    if (!d.isOK()) {
      return;
    }
    LineHandler h = d.handler();
    affectedRoots.add(d.getRoot());
    HandlerUtil.doSynchronously(h, Bundle.getString("resetting.title"), h.printableCommandLine());
  }
}
