...
import org.community.intellij.plugins.communitycase.merge.PullDialog;
 ...
 * "pull" action
 */
public class Pull extends RepositoryAction {
  ...
  protected String getActionName() {
    return Bundle.getString("pull.action.name");
  }
  ...
  protected void perform(@NotNull final Project project,
    ...
    PullDialog dialog = new PullDialog(project, Roots, defaultRoot);
    dialog.show();
    if (!dialog.isOK()) {
      return;
    }
    ...
    try {
      HandlerUtil.doSynchronously(h, Bundle.message("pulling.title", dialog.getRemote()), h.printableCommandLine());
    }
    finally {
    ...
    MergeUtil.showUpdates(this, project, exceptions, root, currentRev, beforeLabel, getActionName(), ActionInfo.UPDATE);
  }
